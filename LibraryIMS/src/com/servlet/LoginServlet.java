...
public class LoginServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	boolean flag1=AdminDAO.validateUser(ui, password, con1);
    	boolean flag2=StudentDAO.validateUser(ui, password, con2);
    	boolean flag3=TeacherDAO.validateUser(ui, password, con3);
